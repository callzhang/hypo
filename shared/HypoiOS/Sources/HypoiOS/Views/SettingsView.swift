...
/// Mirrors the Android settings screen, minus the sections that are Android
/// platform concerns (battery optimisation, SMS permission, accessibility
/// service) and plus the local network row iOS needs.
        ...
        NavigationStack {
            List {
                ...
                Section("Permissions") {
                    ...
                    // makes Bonjour fail silently, with no error anywhere.
