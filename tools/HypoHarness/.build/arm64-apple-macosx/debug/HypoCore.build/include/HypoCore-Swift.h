...
#ifndef HYPOCORE_SWIFT_H
#define HYPOCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HypoCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8HypoCore16BonjourPublisher")
...
@class NSString;
@class NSNumber;
@interface BonjourPublisher (SWIFT_EXTENSION(HypoCore)) <NSNetServiceDelegate>
...
SWIFT_CLASS("_TtC8HypoCore21LanWebSocketTransport")
@interface LanWebSocketTransport : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface LanWebSocketTransport (SWIFT_EXTENSION(HypoCore)) <NSURLSessionDelegate>
...
@interface LanWebSocketTransport (SWIFT_EXTENSION(HypoCore)) <NSURLSessionWebSocketDelegate>
...
SWIFT_CLASS("_TtC8HypoCore31NetServiceBonjourBrowsingDriver")
@interface NetServiceBonjourBrowsingDriver : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface NetServiceBonjourBrowsingDriver (SWIFT_EXTENSION(HypoCore)) <NSNetServiceDelegate>
...
@interface NetServiceBonjourBrowsingDriver (SWIFT_EXTENSION(HypoCore)) <NSNetServiceBrowserDelegate>
...
SWIFT_CLASS("_TtC8HypoCore18WebSocketTransport")
@interface WebSocketTransport : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface WebSocketTransport (SWIFT_EXTENSION(HypoCore)) <NSURLSessionDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session didReceiveChallenge:(NSURLAuthenticationChallenge * _Nonnull)challenge completionHandler:(void (^ _Nonnull)(NSURLSessionAuthChallengeDisposition, NSURLCredential * _Nullable))completionHandler;
@end

@interface WebSocketTransport (SWIFT_EXTENSION(HypoCore)) <NSURLSessionWebSocketDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session webSocketTask:(NSURLSessionWebSocketTask * _Nonnull)webSocketTask didOpenWithProtocol:(NSString * _Nullable)protocolName;
- (void)URLSession:(NSURLSession * _Nonnull)session webSocketTask:(NSURLSessionWebSocketTask * _Nonnull)webSocketTask didCloseWithCode:(NSURLSessionWebSocketCloseCode)closeCode reason:(NSData * _Nullable)reason;
- (void)URLSession:(NSURLSession * _Nonnull)session task:(NSURLSessionTask * _Nonnull)task didCompleteWithError:(NSError * _Nullable)error;
@end
